...
{
    /// <inheritdoc />
    public partial class VolumeBeforeChange : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LiquidTypeId = table.Column<int>(type: "INTEGER", nullable: false),
                    VolumeAdded = table.Column<double>(type: "REAL", nullable: false),
                    DateAdded = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LiquidAddition", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TankProcessId = table.Column<int>(type: "INTEGER", nullable: true),
                    ...
                    VolumeBeforeChange = table.Column<double>(type: "REAL", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TankLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TankLogs_LiquidTypes_LiquidTypeId",
                        column: x => x.LiquidTypeId,
                        principalTable: "LiquidTypes",
                        principalColumn: "Id");
                    table.ForeignKey(
