...
namespace Agas1.Logic.Migrations
{
    ...
    [Migration("20241028120548_VolumeBeforeChange1")]
    partial class VolumeBeforeChange1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Agas1.App.Data.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Agas1.Logic.Models.TankLog", b =>
                {
                    ...
                    b.Property<double>("VolumeBeforeChange")
                        .HasColumnType("REAL");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Agas1.App.Data.ApplicationUser", null)
                        .WithMany()
